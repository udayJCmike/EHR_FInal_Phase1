...
- (IBAction)checkboxselected:(UIButton *)sender {
    ...
    if (pos.selected)
    {
        postiveText.hidden=NO;
    }
    else
    {
        postiveText.hidden=YES;
    }
}
- (IBAction)save:(id)sender {
    ...
    if(pos.selected)
    {
        if ((([postiveText.text length]>0) && ([du otherfields:postiveText.text]==1)) || ([postiveText.text length]==0))
        {
            if ([postiveText.text isEqualToString:@""])
            {
                postiveText.text=@"";
            }
            [recorddict setValue:postiveText.text forKey:@"E_positive for"];
        }
    }
    else
    {
...
-(NSString *)HttpPostEntityFirst1:(NSString*)firstEntity ForValue1:(NSString*)value1 EntitySecond:(NSString*)secondEntity ForValue2:(NSString*)value2
{
    ...
    NSString *post1=[[NSString alloc] initWithFormat:@"views3=%@&negative_3=%@&break_3=%@&break_text3=%@&osteoporosis_3=%@&osteoporosis_select3=%@&hyperkyphosis_3=%@&hyperkyphosis_select3=%@&normalkyphosis_3=%@&normalkyphosis_select3=%@&hypokyphosis_3=%@&hypokyphosos_select_3=%@&degenerative_3=%@&degenerative_select3=%@&mild_3=%@&moderate_3=%@&severe_3=%@&narrowed_3=%@&narrowed_text3=%@&anterior_3=%@&anterior_text3=%@&subchondral_3=%@&subchondral_text3=%@&schmorls_3=%@&schmorls_text3=%@&spondylolisthesisof_3=%@&spondylolisthesisof_select3=%@&other_text3=%@&grade_3=%@&decreasedRLF_3=%@&decreasedLLF_3=%@&facettropism_3=%@&sacralization_3=%@&lumbarization_3=%@&dextro_Levoscoliosis_towering_select3=%@&mild_33=%@&moderate_33=%@&severe_33=%@&apexat_3=%@&apexat_text3=%@&softtissueedemaof_3=%@&softtissueedemaof_text3=%@&other_3=%@&other_text33=%@&views4=%@&normal_4=%@&positivefor_4=%@&%@=%@",[recorddict objectForKey:@"L_views"],[recorddict objectForKey:@"L_negative for recent"],[recorddict objectForKey:@"L_break1"],[recorddict objectForKey:@"L_break"],[recorddict objectForKey:@"L_osterporo11"],[recorddict objectForKey:@"L_oster"],[recorddict objectForKey:@"L_hyperkypho1"],[recorddict objectForKey:@"L_hyper"],[recorddict objectForKey:@"L_normalkypho1"],[recorddict objectForKey:@"L_normal"],[recorddict objectForKey:@"L_hypokypho1"],[recorddict objectForKey:@"L_hypo"],[recorddict objectForKey:@"L_degen1"],[recorddict objectForKey:@"L_Degenerative joint "],[recorddict objectForKey:@"L_mild1"],[recorddict objectForKey:@"L_moderate1"],[recorddict objectForKey:@"L_severe1"],[recorddict objectForKey:@"L_narrow11"],[recorddict objectForKey:@"L_narrow"],[recorddict objectForKey:@"L_anterior11"],[recorddict objectForKey:@"L_anterior"],[recorddict objectForKey:@"L_sub11"],[recorddict objectForKey:@"L_sub"],[recorddict objectForKey:@"L_sch11"],[recorddict objectForKey:@"L_sch"],[recorddict objectForKey:@"L_spon1"],[recorddict objectForKey:@"L_spon"],[recorddict objectForKey:@"L_other1"],[recorddict objectForKey:@"L_grade"],[recorddict objectForKey:@"L_decrlf1"],[recorddict objectForKey:@"L_decllf1"],[recorddict objectForKey:@"L_fact1"],[recorddict objectForKey:@"L_sac1"],[recorddict objectForKey:@"L_lumb1"],[recorddict objectForKey:@"L_dlt"],[recorddict objectForKey:@"L_mild11"],[recorddict objectForKey:@"L_moderate11"],[recorddict objectForKey:@"Lsevere11"],[recorddict objectForKey:@"L_apex11"],[recorddict objectForKey:@"L_apex"],[recorddict objectForKey:@"L_soft11"],[recorddict objectForKey:@"L_soft"],[recorddict objectForKey:@"L_other111"],[recorddict objectForKey:@"L_other"],[recorddict objectForKey:@"E_views"],[recorddict objectForKey:@"E_normal1"],[recorddict objectForKey:@"E_positive for"],secondEntity,value2];
...
-(void)dismissKeyboard{
    [viewtext resignFirstResponder];
      [postiveText resignFirstResponder];
