...
-(void)displaydata
{
    ...
    if ([resultset count]>0)
    {
        ...
        if ([[resultset objectForKey:@"sportoptional"]isEqualToString:@"I do not play a sport or an instrument(You may skip this section.)"])
        {
...
- (IBAction)save:(id)sender
{
    ...
    if((([sport.text length]>0)&&([du otherfields:sport.text]==1))||([sport.text length]==0))
    {
        ...
        if (dontplay.selected) {
            [recorddict setValue:@"I do not play a sport or an instrument(You may skip this section.)" forKey:@"dontplay"];
