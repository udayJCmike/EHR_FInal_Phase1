...
-(NSString *)HttpPostGetdetails:(NSString*)firstEntity ForValue1:(NSString*)value1 EntitySecond:(NSString*)secondEntity ForValue2:(NSString*)value2
{
    ...
    NSString *url1=@"NeckmidDisability.php?service=neckmidselect";
...
-(void)Getdata
{
    ...
    NSArray *items1App=[itemsApp objectForKey:@"Neckindexuser List"];
    ...
    if ([items1App count]>0)
    {
        ...
        for (id anUpdate1 in items1App)
        {
            ...
            temp=[arrayList1 objectForKey:@"Neckindex_no"];
            ...
            temp13=[arrayList1 objectForKey:@"concentration"];
            temp14=[arrayList1 objectForKey:@"score"];
            temp15=[arrayList1 objectForKey:@"status"];
            ...
            [resultset setObject:temp15  forKey:@"status"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"neckback1"])
    {
        ...
        //        NSLog(@"recorddict in neck back first %@",res);
    }
